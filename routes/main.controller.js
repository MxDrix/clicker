...
*/
    ...
    */
    const addOrRejectWithoutFinding = (req, model) => {
        ...
        return new Promise( (resolve, reject) => {
            ...
            Models[model].findOne(requestOptions, (error, item) => {
                ...
                if(error) { 
                    ...
                    return reject( Vocabulary.errors.notNew ) 
                } else {
                    // Save item in DB
                    Models[model].create(req.body)
    ...
    */
    ...
    const findAllWithSubDocument = (model, subDocument) => {
        return new Promise( (resolve, reject) => {
            // Fecth model by id
            Models[model].find({})
...
*/
    module.exports = { 
        addOrRejectWithoutFinding, 
        findOneRejectOrCreate, 
        findOneAndPushId, 
        findOneAndAddId, 
        findOneAndDelete, 
        fetchSingle, 
